    ...
    <>
        <div className="pt-3 cursor-pointer pb-6 flex items-center space-x-12">
            <div 
                ...
                className={`pb-4 flex flex-col items-center space-y-2 border-b-2 ${dataCategory == 'Beach' ? 'Border-gray-800': 'border-white'} opacity-60 hover:opacity-100 hover:border-gray-200`}
                > 
                        <Image 
                            src="/cat.jpeg" 
                            alt='Category - Beach' 
